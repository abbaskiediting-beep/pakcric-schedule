  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      <Helmet>
        ...
        <meta name="description" content="Latest ICC ODI team rankings 2026. Review Pakistan's current standing in the world One Day International rankings and top teams list." />
      </Helmet>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-12">
        ...
        <div className="max-w-2xl space-y-4">
          ...
          <p className="text-sm text-ink/60 font-medium leading-relaxed">
            Explore the accurate ICC ODI team standings for 2026. Pakistan's progress in the 50-over format is closely monitored after each bilateral series and multi-nation event.
          </p>
        </div>
      </motion.div>
