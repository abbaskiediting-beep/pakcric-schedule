      ...
      <div className="grid grid-cols-1 gap-8 mb-16">
        <div className="bg-card-bg border border-card-border rounded-[40px] p-10 md:p-16">
          ...
          <div className="space-y-6 text-ink/60 font-medium leading-relaxed text-lg">
            ...
            <p>
              Our team consists of lifelong cricket enthusiasts who understand the emotional connection fans have with the team. Every piece of information on this site is verified before being published, often cross-referencing with the <a href="https://www.pcb.com.pk/" target="_blank" rel="noopener noreferrer" className="text-pak-green hover:underline">Official PCB portal</a>. We pride ourselves on the accuracy of our <strong>match timings World Cup 2026</strong> and our ability to provide the fastest updates on <Link to="/schedule" className="text-pak-green hover:underline">series fixtures</Link>. For those looking for historical archives, we recommend the <a href="https://www.espncricinfo.com/team/pakistan-7" target="_blank" rel="noopener noreferrer" className="text-pak-green hover:underline">Pakistan profile on ESPNcricinfo</a>. Thank you for choosing us as your definitive source for Pakistan cricket. Together, we cheer for the Green Shirts!
            </p>
          </div>
        </div>
      </div>
