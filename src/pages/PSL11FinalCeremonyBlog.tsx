          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-bold text-white/40 uppercase tracking-[2px]">News Lead</span>
                <span className="text-[14px] font-black text-white uppercase tracking-widest">Omar Farooq</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-8">
            ...
            >
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-lg text-white/60 mb-10 leading-relaxed italic">
                ...
                <div className="bg-gradient-to-br from-pak-green/20 to-transparent border border-pak-green/30 p-8 rounded-3xl mb-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex justify-between items-center py-4 border-b border-white/10 text-sm">
                      ...
                      <span className="font-black text-white underline">4:00 PM PKT</span>
                    </div>
                    <div className="flex justify-between items-center py-4 border-b border-white/10 text-sm">
                    ...
                    <div className="flex justify-between items-center py-4 border-b border-white/10 text-sm">
                      ...
                      <span className="font-black text-white underline">#NewEra</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
                  {performers.map((artist) => (
                    <div key={artist.name} className="p-6 bg-white/5 border border-white/10 rounded-2xl group hover:border-pak-green transition-all">
                      <div className="text-[10px] font-black text-pak-green uppercase tracking-widest mb-1">{artist.role}</div>
                      <div className="text-[18px] font-black group-hover:text-pak-green transition-colors mb-2">{artist.name}</div>
                      <div className="text-[11px] font-bold text-white/40 uppercase">{artist.genre}</div>
                    </div>
                  ))}
                </div>
